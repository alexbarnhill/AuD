...
public class WrittenRecursiveMultiplicationPublicTest {
	...
	public void pubTest_writtenMulRec4__RECURSION_CHECK__THIS_TEST_IS_VERY_IMPORTANT__IF_IT_FAILS_THEN_YOU_WILL_GET_NO_POINTS_AT_ALL() {
		...
		long[][] log_xs = { { 42 }, { 3, 1, 1, 1, 1 }, //
				{ 10, 2, 1, 1, 0, 0, 2, 1, 1, 0, 0, 2, 1, 1, 0, 0, 2, 1, 1, 0, 0 }, //
				{ 42, 5, 2, 2, 1, 1, 5, 2, 1, 1, 0, 0, 2, 1, 1, 2, 1, 1, 0, 0, 2, 1, 1, 0, 0 } //
		};
		long[][] log_ys = { { 0 }, { 4, 2, 0, 2, 0 }, //
				{ 10, 2, 1, 0, 1, 0, 2, 1, 0, 1, 0, 2, 1, 0, 1, 0, 2, 1, 0, 1, 0 }, //
				{ 23, 2, 1, 0, 1, 0, 7, 3, 1, 1, 1, 1, 1, 3, 1, 2, 1, 0, 1, 0, 7, 3, 1, 3, 1 } //
		};
		long[][] log_stacks = { { 1 }, { 1, 2, 2, 2, 2 }, { 1, 2, 3, 3, 3, 3, 2, 3, 3, 3, 3, 2, 3, 3, 3, 3, 2, 3, 3, 3, 3 }, //
				{ 1, 2, 3, 3, 3, 3, 2, 3, 4, 4, 4, 4, 3, 3, 3, 2, 3, 3, 3, 3, 2, 3, 3, 3, 3 } //
		};
	...
	public void pubTest_writtenMulRec3__RECURSION_CHECK__THIS_TEST_IS_VERY_IMPORTANT__IF_IT_FAILS_THEN_YOU_WILL_GET_NO_POINTS_AT_ALL() {
		...
		long[] ys = { 0, 4, 10, 23 };
		long[] expecteds = { 42 * 0, 3 * 4, 10 * 10, 42 * 23 };
		long[][] log_xs = { { 42 }, { 3, 1, 2, 1, 1, 0, 1 }, //
				{ 10, 2, 1, 1, 0, 4, 2, 1, 1, 0, 2, 1, 1, 0, 0, 2, 1, 1, 0 }, //
				{ 42, 5, 2, 3, 1, 7, 1, 4, 2, 2, 1, 1, 0, 0, 3, 2, 1, 1, 0 } //
		};
		long[][] log_ys = { { 0 }, { 4, 2, 2, 1, 1, 0, 0 }, //
				{ 10, 2, 1, 1, 0, 4, 2, 1, 1, 0, 2, 1, 1, 0, 0, 2, 1, 1, 0 }, //
				{ 23, 2, 1, 1, 0, 9, 2, 3, 1, 2, 1, 1, 0, 1, 1, 7, 3, 4, 1 } //
		};
		long[][] log_stacks = { { 1 }, { 1, 2, 2, 3, 3, 3, 2 }, //
				{ 1, 2, 3, 3, 3, 2, 3, 4, 4, 4, 3, 4, 4, 4, 3, 2, 3, 3, 3 }, //
				{ 1, 2, 3, 3, 3, 2, 3, 3, 4, 4, 5, 5, 5, 4, 3, 2, 3, 3, 3 } //
		};
		for (int i = 0; i < xs.length; i++) {
